...
import com.aiaq.model.dto.question.QuestionAnswer;
...
public class AiTestScoringStrategy implements ScoringStrategy {
    ...
    public UserAnswer doScore(List<String> choices, App app) throws Exception {
        ...
        try {
            ...
            QuestionVO questionVO = questionService.detailQuestion(appId, request);
            ...
            String content = (String) JSONUtil.parse(result).getByPath("message.content");
            // 截取需要的 JSON 信息
    ...
    private String getAiTestScoringUserMessage(App app, List<QuestionContent> questionContentDTOList, List<String> choices) {
        ...
        for (int i = 0; i < questionContentDTOList.size(); i++) {
            QuestionAnswer questionAnswerDTO = new QuestionAnswer();
            questionAnswerDTO.setTitle(questionContentDTOList.get(i));
